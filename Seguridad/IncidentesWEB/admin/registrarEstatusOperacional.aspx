<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarEstatusOperacional.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarEstatusOperacional" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                <h2>Registro de Estatus Operacional</h2>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblEstatusOperacional_id" Text="<%#((TB_EstatusOperacionalBE)Container.DataItem).EstatusOperacional_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtEstatusOperacional_desc" Text="<%#((TB_EstatusOperacionalBE)Container.DataItem).EstatusOperacional_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtEstatusOperacional" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtEstatusOperacional" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
