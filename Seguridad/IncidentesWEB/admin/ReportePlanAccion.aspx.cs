            ...
            , string _Estado, DateTime _Fecha_incidente, DateTime _Fecha_incidente1)
        {
            ...
            for (int i = 0; i < TotalRegistros; i++)
            {
                ...
                Tabla.AppendLine("<tr>");
                        ...
                        Tabla.Append("<td><a href=\"#\" onClick=\"PopUp('ActualizarPlanAccion.aspx?PlanAccion_id=" + _idEtiqueta + "',20,20,950,678); return false;\"> " + Resultados.Rows[i]["PlanAccion_desc"] + " </a></td>");
