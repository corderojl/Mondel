<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarClasificacion.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarClasificacion" %>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblClasificacion_id" Text="<%#((TB_ClasificacionBE)Container.DataItem).Clasificacion_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtClasificacion_desc" Text="<%#((TB_ClasificacionBE)Container.DataItem).Clasificacion_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtClasificacion" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtClasificacion" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
