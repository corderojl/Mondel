           ...
           // _idArea = Convert.ToInt32(ddlDepartamento.SelectedValue);
            ...
            if (_dt_func_grupos.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < TotalRegistros; i++)
                {
                    ...
                    Tabla.Append("<td> <a href=\"#\" onClick=\"PopUp('ActualizarDepartamento.aspx?funcionario_id=" + _dt_func_grupos.Rows[i]["FUNCIONARIO_ID"] + "',20,20,950,678); return false;\"> cambiar </a></td>");
                    Tabla.Append(Environment.NewLine);
                    Tabla.Append("</tr>");
                }
                Tabla.Append(Environment.NewLine);
