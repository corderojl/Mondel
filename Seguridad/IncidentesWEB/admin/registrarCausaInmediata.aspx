<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarCausaInmediata.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarCausaInmediata" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                <h2>Registro de Causa Inmediata</h2>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblCausaInmediata_id" Text="<%#((TB_CausaInmediataBE)Container.DataItem).Causainmediata_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCausaInmediata_desc" Text="<%#((TB_CausaInmediataBE)Container.DataItem).Causainmediata_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCausaInmediata" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCausaInmediata" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
