<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarCausaRaiz.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarCausaRaiz" %>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblCausaRaiz_id" Text="<%#((TB_CausaRaizBE)Container.DataItem).CausaRaiz_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCausaRaiz_desc" Text="<%#((TB_CausaRaizBE)Container.DataItem).CausaRaiz_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCausaRaiz" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCausaRaiz" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
