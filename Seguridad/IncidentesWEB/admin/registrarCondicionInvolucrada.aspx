<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarCondicionInvolucrada.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarCondicionInvolucrada" %>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblCondicionInvolucrada_id" Text="<%#((TB_CondicionInvolucradaBE)Container.DataItem).Condicion_inv_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCondicionInvolucrada_desc" Text="<%#((TB_CondicionInvolucradaBE)Container.DataItem).Condicion_inv_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCondicionInvolucrada" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCondicionInvolucrada" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
