<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarResponsablePilar.aspx.cs" Inherits="IncidentesWEB.registrarResponsablePilar" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido" class="cms">
            <div id="panel" class="custom_form">
                <h2>Administrar Responsables de Pilar</h2>
                <asp:ScriptManager ID="ScriptManager1" runat="server">
                </asp:ScriptManager>
                <table class='CSSTableGenerator' style="width: 100%;">
                    <tr>
                    <td>
                        <asp:DropDownList ID="ddlPilar" runat="server"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlPilar" Display="Dynamic" ErrorMessage="*" Font-Size="Large" InitialValue="0"></asp:RequiredFieldValidator>
                    </td>
                        <td>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="display:none">
                                        <asp:Label ID="lblPilar_id" Text='<%# DataBinder.Eval(Container.DataItem, "Pilar_id") %>' runat="server" />
                                    </td>
                                    <td style="display:none">
                                        <asp:Label ID="lblFuncionario_id" Text='<%# DataBinder.Eval(Container.DataItem, "Funcionario_id") %>' runat="server" />
                                    </td>
                                    <td><%# DataBinder.Eval(Container.DataItem, "Pilar_desc") %> </td>
