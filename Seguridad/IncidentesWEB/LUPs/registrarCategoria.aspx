<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarCategoria.aspx.cs" Inherits="IncidentesWEB.LUPs.registrarCategoria" %>
        ...
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:DropDownList ID="ddlPilar" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlPilar_SelectedIndexChanged"></asp:DropDownList>
                        <div id="tabla>">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="display: none">
                                                <asp:Label ID="lblCategoria_id" Text="<%#((LUP_CategoriaBE)Container.DataItem).Categoria_id%>" runat="server" />
                                            </td>
                                            <td>
                                                <%# Container.ItemIndex +1%>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtCategoria_desc" Text="<%#((LUP_CategoriaBE)Container.DataItem).Categoria_desc%>" Width="90%" runat="server" />
                                            </td>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <asp:TextBox ID="txtCategoria" Width="90%" runat="server" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCategoria" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                </td>
