        ...
        <div id="contenido" class="cms">
            <div id="panel" class="custom_form">
                ...
                <div id="Aprobadores">
                    ...
                    <asp:Button ID="btnEliminar" runat="server" Text="Eliminar" CssClass="botonF" OnClientClick="return confirm('¿Deseas Eliminar el registro?')" OnClick="btnEliminar_Click"/>
