<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarCriticidad.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarCriticidad" %>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblElemntoClave_id" Text="<%#((TB_CriticidadBE)Container.DataItem).Criticidad_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCriticidad_desc" Text="<%#((TB_CriticidadBE)Container.DataItem).Criticidad_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtCriticidad" Width="90%" runat="server" />
                                        </td>
