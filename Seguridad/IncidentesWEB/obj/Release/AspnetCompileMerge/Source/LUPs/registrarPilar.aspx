<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarPilar.aspx.cs" Inherits="IncidentesWEB.LUPs.registrarPilar" %>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblPilar_id" Text="<%#((TB_PilarBE)Container.DataItem).Pilar_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtPilar_desc" Text="<%#((TB_PilarBE)Container.DataItem).Pilar_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtPilar" Width="90%" runat="server" />
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPilar" Display="Dynamic" ErrorMessage="*" Font-Size="X-Large" InitialValue=""></asp:RequiredFieldValidator>
                                        </td>
