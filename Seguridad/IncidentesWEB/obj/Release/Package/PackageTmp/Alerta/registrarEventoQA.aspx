<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarEventoQA.aspx.cs" Inherits="IncidentesWEB.admin.registrarEventoQA" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                <h2>Administrar Tipo de Evento de QA</h2>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="display: none">
                                                <asp:Label ID="lblArea_id" Text="<%#((ALR_SistemaqaBE)Container.DataItem).SistemaQA_id%>" runat="server" />
                                            </td>
                                            <td>
                                                <%# Container.ItemIndex +1%>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtArea_desc" Text="<%#((ALR_SistemaqaBE)Container.DataItem).SistemaQA_desc%>" Width="90%" runat="server" />
                                            </td>
