<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarGuardia.aspx.cs" Inherits="IncidentesWEB.admin.registrarGuardia" %>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="display: none">
                                                <asp:Label ID="lblArea_id" Text="<%#((TB_GuardiaBE)Container.DataItem).Guardia_id%>" runat="server" />
                                            </td>
                                            <td>
                                                <%# Container.ItemIndex +1%>
                                            </td>
                                            <td>
                                                <asp:TextBox ID="txtArea_desc" Text="<%#((TB_GuardiaBE)Container.DataItem).Guardia_desc%>" Width="90%" runat="server" />
                                            </td>
