<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarResponsableCategoria.aspx.cs" Inherits="IncidentesWEB.LUPs.registrarResponsableCategoria" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido" class="cms">
            <div id="panel" class="custom_form">
                <h2>Administrar Responsables de Categoria</h2>
                ...
                <table class='CSSTableGenerator' style="width: 100%;">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlCategoria" runat="server"></asp:DropDownList>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlCategoria" Display="Dynamic" ErrorMessage="*" Font-Size="Large" InitialValue="0"></asp:RequiredFieldValidator>
                    </td>
                        <td>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="display:none">
                                        <asp:Label ID="lblCategoria_id" Text='<%# DataBinder.Eval(Container.DataItem, "Categoria_id") %>' runat="server" />
                                    </td>
                                    <td style="display:none">
                                        <asp:Label ID="lblFuncionario_id" Text='<%# DataBinder.Eval(Container.DataItem, "Funcionario_id") %>' runat="server" />
                                    </td>
                                    <td><%# DataBinder.Eval(Container.DataItem, "Categoria_desc") %> </td>
