<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rptEvaluacionColegaAll.aspx.cs" Inherits="IncidentesWEB.Indicadores.rptEvaluacionColegaAll" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt" style="margin-right: 27px" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" Width="767px" Height="529px">
                <LocalReport ReportEmbeddedResource="IncidentesWEB.Indicadores.Reportes.rptReporteColegaPrint.rdlc">
                    <DataSources>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData" TypeName="dsIndicadoresTableAdapters.sp_ListarEVA_EvaluacionDetalleByEvaluacionReporteAllTableAdapter"></asp:ObjectDataSource>
