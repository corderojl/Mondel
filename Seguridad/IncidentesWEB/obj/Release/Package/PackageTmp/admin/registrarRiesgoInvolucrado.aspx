<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarRiesgoInvolucrado.aspx.cs" Inherits="IncidentesWEB.Alerta.registrarRiesgoInvolucrado" %>
    ...
    <form id="form1" runat="server">
        <div id="contenido_form" class="cms">
            <div id="panel" class="custom_form">
                <h2>Registro de Comportamiento Involucrado</h2>
                    ...
                    <ContentTemplate>
                        <div id="tabla>">
                                ...
                                <ItemTemplate>
                                    ...
                                    <tr>
                                        <td style="display:none">
                                            <asp:Label ID="lblRiesgoInvolucrado_id" Text="<%#((TB_RiesgoInvolucradoBE)Container.DataItem).Riesgo_inv_id%>" runat="server" />
                                        </td>
                                        <td>
                                            <%# Container.ItemIndex +1%>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtRiesgoInvolucrado_desc" Text="<%#((TB_RiesgoInvolucradoBE)Container.DataItem).Riesgo_inv_desc%>" Width="90%" runat="server" />
                                        </td>
                            ...
                            <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtRiesgoInvolucrado" Width="90%" runat="server" />
                                        </td>
